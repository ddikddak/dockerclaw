...
export function Card({ 
  ...
  const handleToggleCheck = async (componentId: string, itemIndex: number, checked: boolean) => {
      ...
      case 'code':
        return (
          <CodeComponent 
            ...
            cardId={card.id}
            editable={!!onEditText}
            onSave={(code) => handleEditText('code', code)}
          />
        )
      case 'checklist':
        return (
          <ChecklistComponent 
            ...
            onToggle={(index, checked) => handleToggleCheck('checklist', index, checked)}
          />
        )
      case 'text':
      default:
